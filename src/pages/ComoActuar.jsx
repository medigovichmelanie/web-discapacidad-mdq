...
export default function ComoActuar() {
  return (
    <section className="container">
      {/* INTRO (vidrio) */}
      <header className="page-intro-mdq reveal" aria-labelledby="ca-title">
        <div>
          <p className="page-intro-mdq__eyebrow">Guía rápida</p>
          <h1 id="ca-title" className="page-intro-mdq__title">Cómo actuar</h1>
      ...
      {/* BLOQUE FINAL */}
      <section className="callout-mdq reveal text-center" role="complementary" aria-label="Consulta rápida">
